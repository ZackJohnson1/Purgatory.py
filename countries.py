# This countries list contains dictionaries for each country containing the Timezone, country code, continent, name, and capital.
# The countries are indexed from 0 through 192
